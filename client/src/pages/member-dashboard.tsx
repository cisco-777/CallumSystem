    ...
    <div className="min-h-screen bg-gray-50 mobile-p-3">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 space-y-4 sm:space-y-0">
          <div>
            <h1 className="mobile-h1 font-bold text-gray-900">Member Dashboard</h1>
            <p className="mobile-text-sm text-gray-600 mt-1">Welcome back, John Doe</p>
          </div>
          <Button
            onClick={handleLogout}
            variant="outline"
            size="sm"
            className="text-gray-600 border-gray-300 hover:bg-gray-100 mobile-btn-sm mobile-touch-target w-full sm:w-auto"
          >
        ...
        <div className="mobile-admin-grid mb-6 sm:mb-8">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="mobile-text-xs font-medium text-gray-600">Total Donations</CardTitle>
              <Heart className="h-4 w-4 text-green-600" />
            </CardHeader>
            <CardContent>
              <div className="mobile-text-lg font-bold text-gray-900">{analytics.totalDonations}</div>
              <p className="mobile-text-xs text-gray-500">Last 3 months</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="mobile-text-xs font-medium text-gray-600">Monthly Frequency</CardTitle>
              <TrendingUp className="h-4 w-4 text-blue-600" />
            </CardHeader>
            <CardContent>
              <div className="mobile-text-lg font-bold text-gray-900">{analytics.monthlyFrequency}</div>
              <p className="mobile-text-xs text-gray-500">Donations per month</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="mobile-text-xs font-medium text-gray-600">Preferred Category</CardTitle>
              <BarChart3 className="h-4 w-4 text-purple-600" />
            </CardHeader>
            <CardContent>
              <div className="mobile-text-lg font-bold text-gray-900">{analytics.preferredCategory}</div>
              <p className="mobile-text-xs text-gray-500">Most donated for</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="mobile-text-xs font-medium text-gray-600">Favorite Item</CardTitle>
              <Heart className="h-4 w-4 text-red-600" />
            </CardHeader>
            <CardContent>
              <div className="mobile-text-lg font-bold text-gray-900">
